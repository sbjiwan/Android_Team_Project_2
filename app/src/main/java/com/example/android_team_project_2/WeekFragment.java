...
public class WeekFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        week_grid.setOnItemClickListener((adapterView, view, i, l) -> {
            if (test > 0) {
        ...
        hour_grid.setOnItemClickListener((adapterView, view, i, l) -> {
            ...
            if (My_week_grid.get(i % 7).date > 100) {
                Toast.makeText(activity1, (My_week_grid.get(i % 7).date - 100) + "일 " + i / 7 + "시", Toast.LENGTH_SHORT).show();
                MainActivity.ClickPoint = year + "." + month + "." + (My_week_grid.get(i % 7).date - 100);
            } else {
                Toast.makeText(activity1, My_week_grid.get(i % 7).date + "일 " + i / 7 + "시", Toast.LENGTH_SHORT).show();
